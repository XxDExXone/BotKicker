...
[Add on/off]
[Share on/off]
[Message change:「text」] mengganti message
[Message check]
[Confirm]
[Jam on/off] untuk menghilangkan jam
[Change clock:「name」]
[Up] Update jam
[Cv join]
...
[Ourl] Membuka utl grup
[url]
[url:「Group ID」]
[Invite：「mid」] Mengundang target dengan mid
[Kick：「mid」]
[Ginfo] Info grup
[jointicket]
[Cancel] membatalkan undangan grup yang tertunda
[Gn 「group name」] Ganti nama grup
[Nk 「name」] Kick sesuai nama

[*] Command kicker only [*]

[Bye 1] Mengeluarkan semua bot
[Kill ban] Kick target yang di ban
[Kill 「@」] Kick target
[Ban 「@」] Ban target
[Unban 「@」] Membatalkan Ban Ke target
[Ban︎] Share Contact
[Unban︎] Share Contact
[Banlist︎] Cek yang di ban
[Cek ban] Cek yang di ban
[Cv mid] Mid bot
[Cv ︎invite:「mid」] Invite dengan mid
[Cv ︎rename:「name」] 
[Cv ︎gift] Mengirim Gift
[Respo︎n]
[Bot cancel]
[Title:]
"""
...
admin=["ud3b109ba3e9616fd14581ae02f946fae"]
wait = {
    'contact':True,
    'autoJoin':True,
...
def bot(op):
    try:
        ...
        if op.type == 26:
            ...
            elif msg.text in ["Curl","curl","link off","Link off"]:
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
                    X.preventJoinByTicket = True
                    cl.updateGroup(X)
...
#-----------------------------------------------
                ...
                ki.sendText(msg.to,"Bot siap di jalankan")
                kk.sendText(msg.to,"Ketik help,Help atau Key untuk membuka keyword")
                kc.sendText(msg.to,"ketik /bye bila bosa dengan saya")
#-----------------------------------------------
            elif "Bc " in msg.text:
...
#-----------------------------------------------
            ...
            elif msg.text in ["/bot","/Bot","Bot","bot"]:
                ki.sendText(msg.to,"Bot on")
                kk.sendText(msg.to,"Saya di sini untuk membantu kalian")
                kc.sendText(msg.to,"Bot siap di gunakan ")
...
#-----------------------------------------------
                ...
                ki.sendText(msg.to,"Ada yang bisa saya bantu? 􀨁􀄻double thumbs up􏿿􀜁􀅔Har Har􏿿")
                kk.sendText(msg.to,"Ketik Key untuk melihat Keyword 􀨁􀄻double thumbs up􏿿􀜁􀅔Har Har􏿿")
                kc.sendText(msg.to,"Terimakasih 􀨁􀄻double thumbs up􏿿􀜁􀅔Har Har􏿿")
#-----------------------------------------------
            elif msg.text in ["Respon","respon"]:
                ki.sendText(msg.to,"Cv1 ready")
                kk.sendText(msg.to,"Cv2 ready")
                kc.sendText(msg.to,"Cv3 ready")
#-----------------------------------------------
